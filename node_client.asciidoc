...
In this example, we will replicate the Lighting network example from <<routing_on_a_network_of_payment_channels>>. Specifically, we will create four Lightning nodes named Alice, Bob, Charlie, and Gloria. We will connect Alice to Bob, Bob to Charlie, and Charlie to Gloria. Finally, we will have Gloria create an invoice and have Alice pay that invoice. Since Alice and Gloria are not directly connected, the payment will be routed as an HTLC across all the payment channels.
...
Creating Charlie      ... done
Creating Bob      ... done
Creating Gloria   ... done
Creating Alice    ... done
Creating bitcoind ... done
Attaching to Charlie, Bob, Gloria, Alice, bitcoind
Bob         | Waiting for bitcoind to start...
Charlie         | Waiting for bitcoind to start...
...
Charlie: 03e17cbc7b46d553bade8687310ee0726e40dfa2c629b8b85ca5d888257757edc1
...
To Charlie's node (Eclair) we send:
----
